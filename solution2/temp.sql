...
--	tat_change_2 
--where 
--	mcid = '98e403a6-153d-dd11-93be-0018717a8c82'
--and 
--	date_trunc('MONTH', snapshot_date) = '2021-01-01'


--Now take the sandbox.drag_ration_3 table and append ending ARR to 
	
--For scenario 2 add a filter to sandbox ration 3

,	sandbox_drag_ration_3_1 as 
(
select 
...
where 
	sdr3.snapshot_date >= sdr3."Date to Drag Under Scenario 2"::DATE
)

--Test to see if the filter works: E.g., :dd2996db-9e42-dd11-93be-0018717a8c82

--select 
--	*
--from 
--	sandbox_drag_ration_3_1
--where 
--	mcid = 'dd2996db-9e42-dd11-93be-0018717a8c82'
...
--	tat_change_3 
--where 
--	"Date to Drag to Under Scenario 1"::DATE = '2021-02-01'
--and 
...
select  
	...
	---Put Limit on ARR 
	case 
		when st7.arr > 0 then st7.arr
		else 0 
	end as arr, 
	st7.fx_rate_ccfx, 
	--Put Limit on ARR USD CCFX 
	case 
		when st7.arr_usd_ccfx > 0 then st7.arr_usd_ccfx
		else 0 
	end as arr_usd_ccfx, 
	st7.ccfx_date, 
	st7.mcid_old, 
